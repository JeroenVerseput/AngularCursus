import { Injectable, ChangeDetectionStrategy, Component, Input, ViewEncapsulation, TemplateRef, Output, EventEmitter, NgModule, Inject, InjectionToken, LOCALE_ID, ChangeDetectorRef, ContentChildren, Directive, NgZone, PLATFORM_ID, Injector, Renderer2, ElementRef, ViewContainerRef, ComponentFactoryResolver, forwardRef, ContentChild, defineInjectable, inject, ApplicationRef, RendererFactory2, INJECTOR, ViewChild } from '@angular/core';
...
import { merge, Subject, timer, fromEvent, race, BehaviorSubject } from 'rxjs';
import { filter, map, switchMap, takeUntil, take, delay, withLatestFrom, tap } from 'rxjs/operators';
